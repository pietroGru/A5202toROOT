...
class rdataStruct_FERS():
    ...
    logging = create_logger("rdataStructFERS")
    ...
    def __init__(self, fname, mode="RECREATE", setVars = None):
        ...
        self.FERS_ifers_ch = np.array([0], dtype=np.uint32)
        self.FERS_ifers_lg = np.array([0], dtype=np.int32)
        self.FERS_ifers_hg = np.array([0], dtype=np.int32)
        self.FERS_idet = np.array([0], dtype=np.uint32)
        self.FERS_istrip = np.array([0], dtype=np.uint32)
        ...
        self.FERS_nametypes = [
            ...
            ("fers_ch",         self.FERS_ifers_ch,      "fers_ch/i",        "FERS channel number [0-63]"),
            ("fers_lg",         self.FERS_ifers_lg,      "fers_lg/I",        "FERS low-gain ADC signed value [int32]"),
            ("fers_hg",         self.FERS_ifers_hg,      "fers_hg/I",        "FERS high-gain ADC signed value [int32]"),
            ("det",             self.FERS_idet,          "det/i",            "Detector ID [0,1]"),
            ("strip",           self.FERS_istrip,        "strip/i",          "Strip ID [1-192]"),
